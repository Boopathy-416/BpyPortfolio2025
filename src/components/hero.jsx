    ...
    <section id="hero">
      <div className="relative min-h-screen w-full overflow-hidden bg-black">
        ...
        <main className="relative flex min-h-screen flex-col items-center justify-center px-4">
          ...
          <h1
  className="text-[clamp(3rem,15vw,8rem)] drop-shadow-sm shadow-[0_10px_50px_rgba(255,255,255,0.5)] bg-no-repeat leading-none font-black text-center"
  style={{
    padding: "5rem",
    backgroundImage:
...
>
  Bpy Creation
          ...
          <div
            className="absolute bottom-8 md:bottom-20 transition-all right-10   max-w-xs rounded bg-[#ececec] hover:bg-black  hover:text-white shadow-[0_10px_50px_rgba(255,255,255,0.5)] p-4"
            style={{
              transition: " ease-in 1s",
            }}
          >
            <h2 className="text-xl font-bold">
            Open to work | MERN Stack Developer | Frontend & Backend Expertise | Passionate about UI/UX  | Let's connect!
            </h2>
