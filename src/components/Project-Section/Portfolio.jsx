...
const projects = [
  {
    title: "GAMER STORE ECOMMERCE",
    image: "public/assets/projects/mobile Application.png",
  },
  {
    title: "THE BITCOIN",
    image:
...
export default function Portfolio() {
        ...
        ctx = gsap.context(() => {
          ...
          gsap.fromTo(
            ...
            { opacity: 0, y: 50 },
            {
              ...
              ease: "power3.out",
              scrollTrigger: {
                trigger: mainProjectsRef.current,
                start: "top 80%",
              },
            }
          );
  ...
  return (
    <div
      id="testimonials"
      ref={containerRef}
      className="min-h-screen  backdrop-blur-2xl shadow-black shadow-sm   "
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
        <div className="md:col-span-4 relative h-[600px] bg-black">
          <img
            ...
            alt="Project Image"
            className="object-contain w-full h-full opacity-80 transition-opacity duration-500"
          />
          <div className="absolute bottom-0 backdrop-blur-2xl shadow-black shadow-sm left-0 p-6 text-white">
            <p className="text-sm tracking-widest mb-1">FEATURED PROJECT</p>
            <h2
              ref={projectTitleRef}
              className="md:text-5xl text-3xl font-bold tracking-tight project-name"
            >
              {projects[0].title}
            </h2>
          </div>
      ...
      <div ref={projectDetailsRef} className="md:col-span-8 ">
        <div className="grid grid-cols-2 border-b border-neutral-300">
          <div className="project-item p-6  relative border-r border-neutral-300 opacity-0">
            ...
            <h3 className="md:text-4xl text-xl font-bold tracking-tight uppercase  project-name">
              MERN STACK, react-query, TAILWIND
            </h3>
          </div>
          <div className="project-item p-6 relative opacity-0">
            <p className="text-xs tracking-widest mb-4">ROLE</p>
            <h3 className="md:text-4xl text-2xl font-bold tracking-tight project-name">
        ...
        <div
          ref={mainProjectsRef}
          className="border-b border-neutral-300 opacity-0"
        >
