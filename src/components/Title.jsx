  ...
  return (
    <div className="relative overflow-hidden w-full mt-10 mr-9">
      ...
      <div className="whitespace-nowrap will-change-transform">
        ...
        >
          BPY CREATIONS &nbsp; BPY CREATIONS &nbsp; BPY CREATIONS BPY CREATIONS &nbsp; BPY CREATIONS &nbsp;
        </h1>
      </div>
      ...
      {/* Circular Text */}
<div className="absolute -right-2 top-0 w-32 h-32"> <svg viewBox="0 0 100 100" className="w-full h-full rotate-[30deg]" > <path id="curve" d="M 25,50 a 25,25 0 1,1 50,0 a 25,25 0 1,1 -50,0" fill="none" className="text-[#ececec]" /> <text className="text-[8px]"> <textPath href="#curve" startOffset="0%"> CREATIVE DESIGNER </textPath> </text> </svg> </div>
    </div>
  );
}
